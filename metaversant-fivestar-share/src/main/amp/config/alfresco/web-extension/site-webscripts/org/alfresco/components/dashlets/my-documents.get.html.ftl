...
<@markup id="css" >
   ...
   <@link rel="stylesheet" type="text/css" href="${url.context}/res/components/dashlets/metaversant-ratings.css" group="dashlets"/>
</@>

<@markup id="js">
   <#-- JavaScript Dependencies -->
   <@script type="text/javascript" src="${url.context}/res/components/dashlets/my-documents.js" group="dashlets"/>
   <@script type="text/javascript" src="${url.context}/res/components/dashlets/metaversant-ratings.js" group="dashlets"/>
   <@script type="text/javascript" src="${url.context}/res/components/dashlets/metaversant-my-documents.js" group="dashlets"/>
</@>
...
<@markup id="html">
   <@uniqueIdDiv>
      ...
      <div class="dashlet my-documents">
         <div class="title">SET${msg("header")}</div>
