...
(function()
{
    ...
    */
   Alfresco.component.SimpleDocList.generateRatingsWidget = function SimpleDocList_generateRatingsWidget(scope,record)
   {
   ...
   YAHOO.extend(Alfresco.component.SimpleDocList, Alfresco.component.Base,
   {
      ...
      renderCellDetail: function SimpleDocList_renderCellDetail(elCell, oRecord, oColumn, oData)
      {
         ...
         else
         {
            ...
            {
               dateLine = 'sujay'+ this.msg("details." + dateI18N + "-by", $relTime(dateProperty), $userProfile(record.modifiedByUser, record.modifiedBy, 'class="theme-color-1"'));
            }
            ...
            else
            {
               ...
               if (canComment)
               {
                  desc +=    '<span class="item item-social item-separator">' + Alfresco.component.SimpleDocList.generateComments(this, oRecord) + 'DDD</span>';
               }
               desc+= '<span class="item item-social item-separator">' + Alfresco.component.SimpleDocList.generateFavourite(this, oRecord) + '</span>';
               desc += 'SUJAY</div>';
            }
