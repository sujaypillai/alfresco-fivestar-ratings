...
(function()
{
    ...
    {
        Metaversant.Ratings.superclass.constructor.call(this, htmlId);
    ...
    YAHOO.extend(Metaversant.Ratings, Alfresco.component.Base,
    {
        ...
        renderRatingMarkup: function MetaversantRatings_renderRatingMarkup(ratingDiv)
        {
            ...
            for (var j = 1; j <= this.numStars; j++)
            {
                ...
                if (rating >= 1) {
                    star.setAttribute('src', Alfresco.constants.URL_CONTEXT + 'components/images/stars/rating_on.gif');
                    star.className = 'on';
                    rating--;
                } else if(rating > 0 && rating < 1) {
                    star.setAttribute('src', Alfresco.constants.URL_CONTEXT + 'components/images/stars/rating_half.gif');
                    star.className = 'half';
                    rating = 0;
                } else {
                    star.setAttribute('src', Alfresco.constants.URL_CONTEXT + 'components/images/stars/rating_off.gif');
                    star.className = 'off';
                }
        ...
        displayNormal: function MetaversantRatings_displayNormal(e, obj)
        {
            ...
            for (var i = 1; i <= rating; i++) {
                ...
                document.getElementById(obj.id + '_' + id + '_' + i).setAttribute('src', Alfresco.constants.URL_CONTEXT + 'components/images/stars/rating_' + status + '.gif');
            }
        },
